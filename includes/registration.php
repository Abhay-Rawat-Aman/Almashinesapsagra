<form action="process_form.php" method="POST" enctype="multipart/form-data">
  <div class="row gy-4">
    ...
    <div class="col-md-4">
      ...
      <input type="number" id="addmissionNo" name="admissionNo" class="form-control" placeholder="Admission No" required>
    </div>
    ...
    <div class="col-md-6">
      <label for="marksheet" class="form-label">Upload 12th Marksheet <span class="text-danger">*</span></label>
